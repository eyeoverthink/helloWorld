 ...
 * @author Shai Almog
 */
public class UbezStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Ubez";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new UbezStub());
    }
